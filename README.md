...
اپلیکیشن Element یا Element X را دانلود کنید: از گوگل پلی یا F-Droid برای اندروید، وبرای ios از اپ استور یا سایت رسمی (https://element.io) آن.
یک "Homeserver" انتخاب کنید: این مهم‌ترین مرحله است. Homeserver پایگاه اصلی حساب شماست. 
توصیه مهم: از سرور پیش‌فرض matrix.org یا سرورهای عمومی معتبر دیگر استفاده کنید. ( میتوانید از سرور Wiiz.ir استفاده کنید). و از ساخت حساب روی سرورهای ناشناس خودداری کنید، مگر اینکه مدیر آن را کاملاً بشناسید و اعتماد صددرصدی داشته باشید.
حساب کاربری بسازید: نام کاربری شما شبیه به YourName:server.com@ خواهد بود.
...
استفاده از VPN همچنان، در صورت امکان توصیه می‌شود.
...
اپلیکیشن Delta Chat را میتوانید از گوگل پلی یا F-Droid برای اندروید، وبرای ios از اپ استور یا سایت رسمی (https://delta.chat) دانلود کنید.
حساب کاربری بسازید: میتوانید از ایمیل خود با رله‌های عمومی استفاده کنید. (میتوانید از سرور Tiiiz.ir استفاده کنید). رله‌های عمومی به آدرس (https://chatmail.at/relays) قابل مشاهده هستند.
توصیه امنیتی: از ایمیل اصلی یا کاری خود استفاده نکنید. یک حساب ایمیل جدید (مثلاً یک جیمیل جدید) صرفاً برای این کار بسازید.
برای چت با یک نفر، فقط آدرس ایمیل او را لازم دارید.
...
همچنین در صورت قطع شدن کارسازهای عمومی، شما میتوانید از طریق سرویس‌های ارائه دهنده ایمیل ایرانی استفاده کنید. پیام‌ها همچنان رمزنگاری میشوند و ارایه‌ دهنده به محتوای پیام‌های شما دسترسی نخواهد داشت.
در صورت امکان، استفاده از VPN همچنان برای مخفی کردن IP شما از سرور ایمیل توصیه می‌شود.
...
رمزنگاری پیام‌های متنی و SMS (به کمک Nahoft)
...
شما میتوانید اپلیکیشن نهفت را از اپ استور برای ios , و برای اندروید از گوگل پلی یا سایت رسمی (https://nahoftapp.com) دانلود کنید. همچنین نحوه استفاده از آن هم در سایتش موجود است.
...
اپلیکیشن‌هایی مانند Organic Maps یا OsmAnd Maps به شما اجازه می‌دهند نقشه‌های کامل شهر یا کشور را دانلود کنید تا در زمان عدم دسترسی به GPS یا اینترنت، مسیر خود را پیدا کنید.
...
نکات امنیتی و مهم
در صورت امکان، همیشه از VPN معتبر استفاده کنید: این اولین و مهم‌ترین قدم برای هر فعالیتی در اینترنت است. هر VPN لزوما امن نیست و حتی می تواند امنیت شما را به خطر اندازد.
به مدیر سرور اعتماد کنید: در ماتریکس شما به یک سرور اعتماد می‌کنید. سرورهای معتبر، عمومی انتخاب کنید و یا برای سرورهای خصوصی و ایرانی مطمئن شوید مدیر سرور را می شناسید و به آن اعتماد دارید.
اطلاعات هویتی را هرگز به اشتراک نگذارید: نام، شماره تلفن، آدرس و هر چیزی که هویت واقعی شما را فاش کند، در این شبکه‌ها به اشتراک نگذارید. و در صورت امکان از هویت واقعی خود استفاده نکنید. و برای هر سرویس، یک حساب کاربری جدا (و ایمیل جدا) بسازید. 
ابزارها را از قبل دانلود و آماده کنید. تمام اپلیکیشن‌ها را نصب و آزمایش کنید. یک نسخه از فایل نصبی برنامه‌های مهم را به صورت آفلاین ذخیره کنید. فایل‌ها را فقط از منابع معتبر و اصلی دانلود کنید.
یادتان باشد هیچ فردی در فضای آنلاین نمیتواند امن باشد. فقط به افرادی که می‌شناسید اعتماد کامل کنید.
از امروز آماده شوید! منتظر روز قطعی اینترنت نمانید.
