...
3. برای چت با یک نفر، فقط آدرس ایمیل او را لازم دارید.  
   * اگر طرف مقابل شما هم از دلتاچت استفاده کند، چت شما به صورت خودکار رمزنگاری سرتاسری (End-to-End Encrypted) می‌شود.ٖ(در برخی نسخه ها یک علامت قفل کنار پیام‌ها ظاهر می‌شود)  
